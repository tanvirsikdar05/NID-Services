...
public class rootActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spin_kit=findViewById(R.id.prgbarroot);

        spin_kit.setVisibility(View.VISIBLE);

        webView = findViewById(R.id.webviewidroot);
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, WebChromeClient.FileChooserParams fileChooserParams) {
                ...
                if(file_permission() && Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (includePhoto) {
                        ...
                        if (takePictureIntent.resolveActivity(rootActivity.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
                    ...
                    if (includeVideo) {
                        ...
                        if (takeVideoIntent.resolveActivity(rootActivity.this.getPackageManager()) != null) {
                            File videoFile = null;
                            try {
    ...
    private void LoadStartAppBanner() {
        ...
        Banner banner = new Banner(rootActivity.this, new BannerListener() {
            @Override
    ...
    private void LoadStartAppInterstital() {
        if (startAppAd == null) {
            startAppAd = new StartAppAd(rootActivity.this);
    ...
    private void Loadadmovreward() {
        ...
        RewardedAd.load(rootActivity.this, getString(R.string.rewardid),
    ...
    private void showadmovreward(){
        if (mRewardedAd != null) {
            Activity activityContext = rootActivity.this;
    ...
    private void Loadadmovins() {
        ...
        InterstitialAd.load(rootActivity.this,getString(R.string.instratialid), adRequest,
    ...
    private void showadmovins(){
        if (mInterstitialAd != null) {
            mInterstitialAd.show(rootActivity.this);
        } else {
           Loadadmovins();
        }
    }
    ...
    public boolean file_permission(){
        if(Build.VERSION.SDK_INT >=23 && (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
            ActivityCompat.requestPermissions(rootActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, 1);
            return false;
        }else{
            return true;
        }
